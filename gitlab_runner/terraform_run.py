...
def build_plan(os_flavor, team, home_dir, os_platform, tf_environment):
    ...
    #           '"key=' + team + '-' + os_flavor + '.tfstate" -backend-config "region=us-east-1" '
    ...
    #     tf_plan = (f'terraform plan -var-file={home_dir}{os_flavor}\\\\_{os_flavor}_{tf_environment}.tfvars -state={team}'
    #                f'-{os_flavor}.tfstate -out={home_dir}{os_flavor}\\{os_flavor}.tfplan')
